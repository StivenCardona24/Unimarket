package co.edu.uniquindio.proyecto.segurity.servicios;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException { Optional<Usuario> cliente = clienteRepo.findByEmail(email);
        if(cliente.isEmpty()){
